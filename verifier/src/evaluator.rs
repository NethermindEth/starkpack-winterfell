...
pub fn evaluate_constraints<A: Air, E: FieldElement<BaseField = A::BaseField>>(
    ...
    air.evaluate_transition(num_splits, main_trace_frame, &periodic_values, &mut t_evaluations1);
    ...
    let b_constraints =
        air.get_boundary_constraints(num_splits, &aux_rand_elements, &composition_coefficients.boundary);
